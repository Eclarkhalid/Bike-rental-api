            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <div className="text-center sm:text-left">
                ...
                <p className="mt-1.5 text-md text-gray-500 max-w-md">
                  View the statistics about your business. Also manage and add bicycles and manage orders.
                </p>
              </div>
              ...
              <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                <Link href={'/products'}
                  ...
                  type="button"
                >
                  <span className="text-sm font-medium"> View Bicycles </span>
                ...
                <Link href={'https://bike-rental-frontend-eclarkhalid.vercel.app/'} target="_blank"
  ...
  return <>
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <h1
          className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl max-w-md"
        >
          Welcome to Cycle Hive Rentals
        </h1>
